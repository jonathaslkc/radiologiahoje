<?php
$titulohead = "EBSERV - CONCURSO APROVADO";
$menusel = "blog";
            ...
            <div class="span8">
                <div class="blog">
                    <div class="blog-item well">
                        <a href="#"><h2>EBSERV<br>Concurso Autorizado</h2></a>
                        ...
                        <p><img src="images/ebserv.jpg" style="width:100%;" alt="" /></p>
                        <br>
                        <p>
                            Com a liberação divulgada no Diário Oficial da União (DOU), no dia 21 do mês corrente, o concurso da EBSERV (Empresa Brasileira de Serviços Hospitalares) deve suprir a necessidade de 714 vagas para o Hospital Regional de Lagarto da Universidade Federal de Sergipe de Lagarto (HRL-UFS). 
                        </p>
                        <p>
                            No documento também apresentam vagas para mais dois Hospitais Universitários, o Hospital Universitário Antônio Pedro da Universidade Federal Fluminense - HUAP/UFF e o Hospital Universitário da Universidade Federal de Brasília - HUB-UnB.
                        </p>
                        <br>
                        <strong>Arquivo</strong>
                        <p>
                            <a href="http://pesquisa.in.gov.br/imprensa/jsp/visualiza/index.jsp?data=21/06/2016&jornal=1&pagina=44&totalArquivos=96">Confira aqui</a>
                            a publicação no DOU. Seguem em ordem crescente, Portaria N° 28, 29 e 30.
                        </p>
                        <br><br>

                    <div class="tag">
                        Tags : <a href="#"><span class="label label-success">Radiologia</span></a> 
                        <a href="#"><span class="label label-success">Concurso</span></a> 
